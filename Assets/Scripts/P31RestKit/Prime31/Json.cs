...
namespace Prime31
{
	public class Json
	{
		...
		public static object decode(string json)
		{
			if (useSimpleJson)
			{
				return Prime31.SimpleJson.decode(json);
			}
		...
		public static T decode<T>(string json, string rootElement = null) where T : new()
		{
			if (useSimpleJson)
			{
				return Prime31.SimpleJson.decode<T>(json, rootElement);
			}
		...
		{
			return Prime31.SimpleJson.decodeObject<T>(jsonObject, rootElement);
		}

		public static string encode(object obj)
		{
			string text = ((!useSimpleJson) ? Serializer.serialize(obj) : Prime31.SimpleJson.encode(obj));
			if (text == null)
			{
