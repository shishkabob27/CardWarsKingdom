...
public class KFFDictionary
{
	...
	public override void CreateDictionary()
	{
		dict.Clear();
	...
	public override int GetValueAsInt(string key)
	{
	...
	public override float GetValueAsFloat(string key)
	{
	...
	public override string GetValueAsString(string key)
	{
		string value = GetValue(key);
