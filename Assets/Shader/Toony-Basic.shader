...
"!!GLES3
					...
					t0 = vec4(0.0);
					    ...
					    t0.xyz = in_NORMAL0.yyy * glstate_matrix_modelview0[1].xyz;
					    t0.xyz = glstate_matrix_modelview0[0].xyz * in_NORMAL0.xxx + t0.xyz;
					    vs_TEXCOORD1.xyz = glstate_matrix_modelview0[2].xyz * in_NORMAL0.zzz + t0.xyz;
					    return;
					}
					#endif
					#ifdef FRAGMENT
					...
					t1 = vec4(0.0);
					t10_1 = vec4(0.0);
					    t10_0.xyz = texture(_ToonShade, vs_TEXCOORD1.xyz).xyz;
					    t10_1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    t1 = t10_1 * _Color;
					    t0.xyz = t10_0.xyz * t1.xyz;
					    SV_Target0.w = t1.w;
...
"!!GLES3
					...
					t10_1 = vec4(0.0);
					    ...
					    t10_1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    t10_1 = t10_1 * _Color;
					    t10_1.xyz = t10_0.xyz * t10_1.xyz;
					    SV_Target0 = t10_1 * vec4(2.0, 2.0, 2.0, 2.0);
					    return;
					}
					#endif"
}
