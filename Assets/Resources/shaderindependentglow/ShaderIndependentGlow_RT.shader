...
"!!GLES
					...
					void main ()
					{
					  ...
					  tmpvar_2 = (1.0/(((_ZBufferParams.z * texture2DProj (_CameraDepthTexture, xlv_TEXCOORD0).x) + _ZBufferParams.w)));
...
"!!GLES
					...
					void main ()
					{
					  lowp vec4 c_1;
					  highp float tmpvar_2;
					  tmpvar_2 = (1.0/(((_ZBufferParams.z * texture2DProj (_CameraDepthTexture, xlv_TEXCOORD1).x) + _ZBufferParams.w)));
					  c_1 = vec4(0.0, 0.0, 0.0, 0.0);
