...
"!!GLES
					...
					void main ()
					{
					  lowp vec4 c_1;
					  highp float tmpvar_2;
					  tmpvar_2 = ((texture2DProj (_CameraDepthTexture, xlv_TEXCOORD1).x * _ProjectionParams.z) + _ProjectionParams.y);
					  c_1 = vec4(0.0, 0.0, 0.0, 0.0);
					  if (((xlv_TEXCOORD1.z * _SIG_ZShift) < tmpvar_2)) {
...
"!!GLES3
					...
					#endif
					    if(tb0){
					        t10_0 = texture(_SIG_GlowMask, vs_TEXCOORD0.xy);
					        t16_0 = t10_0 * _SIG_color;
					        SV_Target0 = t16_0;
					    } else {
					        SV_Target0 = vec4(0.0, 0.0, 0.0, 0.0);
...
"!!GLES
					...
					void main ()
					{
					  ...
					  tmpvar_3 = ((texture2DProj (_CameraDepthTexture, xlv_TEXCOORD1).x * _ProjectionParams.z) + _ProjectionParams.y);
					  c_1 = vec4(0.0, 0.0, 0.0, 0.0);
...
"!!GLES3
					...
					tb0 = bool(false);
					t1 = float(0.0);
					    t0.x = texture(_MainTex, vs_TEXCOORD0.xy).w;
					#ifdef UNITY_ADRENO_ES3
					    tb0 = !!(t0.x<_Cutoff);
					#else
					    tb0 = t0.x<_Cutoff;
